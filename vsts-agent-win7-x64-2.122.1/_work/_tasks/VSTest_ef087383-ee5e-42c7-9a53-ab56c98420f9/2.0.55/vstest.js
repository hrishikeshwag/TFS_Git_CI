...
function generateResponseFile(discoveredTests) {
    const startTime = perf();
    let endTime;
    let elapsedTime;
    let definitionRunId;
...
function executeVstest(testResultsDirectory, parallelRunSettingsFile, vsVersion, argsArray) {
    const defer = Q.defer();
...
function cleanFiles(responseFile, listFile) {

...
class DistributedTest {
    ...
    startDtaTestRun() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                settingsFile = yield settingsHelper.updateSettingsFileAsRequired(this.dtaTestConfig.settingsFile, this.dtaTestConfig.runInParallel, this.dtaTestConfig.tiaConfig, null, false, this.dtaTestConfig.overrideTestrunParameters);
